    ...
    <section id="additives" class="section">
         <b-table
            ...
            <template slot-scope="props">
                <b-table-column class="has-text-centered" field="risk" label="Risque" centered sortable>
                    {{ emojize(props.row.risk) }}
                </b-table-column>

                <b-table-column class="has-text-centered" field="additive_name" label="Additif" centered sortable >
                    {{ props.row.additive_name |capitalize }}
                </b-table-column>
    ...
    export default {
        ...
        methods: {
            getAdditives() {
                ...
                this.loading = true
                APIAdditives.getAdditives(params).then((data) => {
